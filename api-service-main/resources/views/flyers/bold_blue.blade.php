...
<html lang="en">
    ...
    <body style="padding:20px;">
        <div style="padding-top: 30px;padding-left: 22px; background-color:#5FCCF6 !important; height:69%;">
        ...
        <footer style="background-color:#5FCCF6 !important;color: #000000;padding: 20px;padding-top: 20px; padding-bottom: 20px !important;margin-top: -1px;position: absolute;bottom: 15; left: 15; right: 15; height: 70px; padding-right:15px;">
