...
<html lang="en">
    <head>
        ...
        <title>throwback_blue.pdf</title>
        <style type="text/css">
            @page {
                margin: 0;
            }
            ...
            .tb-top-section{
                background-image: url("{{ config('uplist.flyer_assets_url') . '/tb-blue-new.png' }}") ;
            ...
            <div class="tb-top-section" style="height:100%; border-top-right-radius:50px;border-top-left-radius:50px;">
                ...
                <div style="width: 200px;height: 160px;position: absolute;bottom: 215px;right: 60px;text-align: center;font-weight: 700;color: #1870b8;">
                    <p style="position: relative;">
                        <span style="width: 170px;position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);line-height: 12px;white-space: nowrap !important;font-size: {{ $addressFontSize }};">{{ $addressApt }} <br/> {{ $property['city'] }}, {{ $property['state_abbreviation'] }} {{ $property['zip'] }}</span>
                    </p>
                </div>
            </div>
