...
<head>
    ...
    .elegant-container {
        background-image: url("{{ config('uplist.flyer_assets_url') . '/Elegant_gold_back.png' }}");
...
<body>
    ...
    <div class="elegant-container gold" style="text-align: center; height: 878px;">
        ...
        <div class="elegant-right-content">
            ...
            <img class="phone-img" src="{{ config('uplist.flyer_assets_url') . '/phone-gold-new.png' }}" alt=""/>
